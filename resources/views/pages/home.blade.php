    ...
    <div class="max-w-[1440px] mx-auto px-3">
        ...
        <div class="md:w-[100%] mx-auto md:mt-5 hidden md:block">
            <div dir="ltr" class="owl-carousel">
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 box-border" src="{{ asset('assets/images/heroSlider/1.jpg') }}" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="{{ asset('assets/images/heroSlider/2.jpg') }}" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="{{ asset('assets/images/heroSlider/3.gif') }}" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="{{ asset('assets/images/heroSlider/4.jpg') }}" alt=""
                        /></a>
                </div>
            </div>
        </div>
        ...
        <div class="md:w-[100%] mx-auto md:mt-5 md:hidden">
            <div dir="ltr" class="owl-carousel">
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 box-border" src="{{ asset('assets/images/heroSlider/1-mobile.jpg') }}" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="{{ asset('assets/images/heroSlider/2-mobile.jpg') }}" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="{{ asset('assets/images/heroSlider/3-mobile.gif') }}" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="{{ asset('assets/images/heroSlider/4-mobile.jpg') }}" alt=""
                        /></a>
                </div>
            </div>
        </div>
        ...
        <div>
            <a href="./search.html">
                <img class="rounded-2xl hidden md:block" src="{{ asset('assets/images/sectionImage/1.jpg') }}" alt="">
            </a>
            <a href="./search.html"></a>
            <img class="rounded-2xl md:hidden" src="{{ asset('assets/images/sectionImage/1-mobile.jpg') }}" alt="">
            </a>
        </div>
        <!-- OFF SLIDER -->
        <div class="flex justify-between px-5 py-5 rounded-xl md:px-10 items-center mt-10 mb-2 bg-white">
            ...
            <a href="./search.html"><div class="transition px-4 py-2 rounded-xl flex justify-center items-center text-red-500 hover:text-red-600">دیدن همه<img class="w-4" src="{{ asset('assets/images/others/arrow-left.png') }}" alt=""></div></a>
        </div>
        <div class="lg:flex items-start gap-5">
            <div class="lg:w-1/3 mb-5 gap-5 lg:mb-0 grid justify-items-center grid-cols-1 sm:grid-cols-2 lg:block">
                <img class="rounded-xl mx-auto" src="{{ asset('assets/images/suggested product/9.webp') }}" alt="">
                <img class="rounded-xl lg:hidden" src="{{ asset('assets/images/suggested product/10.webp') }}" alt="">
            </div>
            <div class="lg:w-2/3">
                <div class="swiper timerProduct border rounded-xl">
                    <div class="swiper-wrapper bg-white">
                        <a href="" class="swiper-slide md:flex bg-white" style="display: flex;">
                            <div class="md:w-1/3">
                                <img class="max-w-80 w-auto mx-auto rounded-xl" src="{{ asset('assets/images/suggested product/1.webp') }}" alt="">
                            </div>
                            <div class="md:w-2/3 flex flex-col justify-center py-5">
                                ...
                                <div class="flex w-96 mt-5 mx-auto">
                                    ...
                                    <div class="w-1/2">
                                        <div class="flex gap-x-1 text-zinc-600 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="swiper mySwiper bg-red-500 rounded-3xl mb-10">
            <div class="swiper-wrapper py-5">
                <div class="card swiper-slide flex flex-col justify-center items-center">
                    <img src="{{ asset('assets/images/others/FeaturedPromos.svg') }}" alt="">
                    <img class="w-full" src="{{ asset('assets/images/others/box.webp') }}" alt="">
                </div>
              ...
              <span class="text-sm opacity-80 mb-4 h-8 md:h-10">
                ...
                <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 bg-white rounded-xl">
                    ...
                    <div class="image-box mb-6 ">
                        <div>
                            <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/8.jpg') }}" alt="" />
                        </div>
                    </div>
                    <div class="space-y-2 text-right">
              <span class="text-sm opacity-80 mb-4 h-8 md:h-10">
                ...
                <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 bg-white rounded-xl">
                    ...
                    <div class="image-box mb-6 ">
                        <div>
                            <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/7.jpg') }}" alt="" />
                        </div>
                    </div>
                    <div class="space-y-2 text-right">
              <span class="text-sm opacity-80 mb-4 h-8 md:h-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <a href="./search.html">
                <img class="rounded-xl" src="{{ asset('assets/images/fourImage/1.jpg') }}" alt="">
            </a>
            <a href="./search.html">
                <img class="rounded-xl" src="{{ asset('assets/images/fourImage/2.jpg') }}" alt="">
            </a>
            <a href="./search.html">
                <img class="rounded-xl" src="{{ asset('assets/images/fourImage/3.jpg') }}" alt="">
            </a>
            <a href="./search.html">
                <img class="rounded-xl" src="{{ asset('assets/images/fourImage/4.jpg') }}" alt="">
            </a>
        </div>
        <!-- GOOD CATEGORYS -->
        <div class="bg-white rounded-2xl py-6 shadow-xl my-10">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-x-4 gap-y-4 md:gap-x-8 2xl:gap-x-10 px-3 md:px-8 lg:px-28">
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/mobile.webp') }}" alt="">
                    <div class="text-sm opacity-90">موبایل</div>
                </a>
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/biutiful.webp') }}" alt="">
                    <div class="text-sm opacity-90">زیبایی</div>
                </a>
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/book.webp') }}" alt="">
                    <div class="text-sm opacity-90">کتاب و دفتر</div>
                </a>
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/digital.webp') }}" alt="">
                    <div class="text-sm opacity-90">کالای دیجیتال</div>
                </a>
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/market.webp') }}" alt="">
                    <div class="text-sm opacity-90">سوپر مارکت</div>
                </a>
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/mode.webp') }}" alt="">
                    <div class="text-sm opacity-90">مد و پوشاک</div>
                </a>
                <a href="./search.html" class="flex justify-center items-center flex-col gap-y-3 hover:scale-105 transition">
                    <img src="{{ asset('assets/images/goodCategory/tools.webp') }}" alt="">
                    ...
                    <div>
                      گوشی ونگارد
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/9.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      کش مخصوص تقویت مچ دست
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/10.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      پاک کننده لوازم دیجیتال
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/11.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      پک لوازم سفر
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/12.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <a href="./search.html">
                <img class="rounded-xl" src="{{ asset('assets/images/twoImage/1.jpg') }}" alt="">
            </a>
            <a href="./search.html">
                <img class="rounded-xl" src="{{ asset('assets/images/twoImage/2.jpg') }}" alt="">
            </a>
        </div>
        <!-- PRODUCT SLIDER 3 -->
        <div class="bg-white rounded-2xl pt-10 shadow-xl my-10">
                ...
                <div class="slide-container1 px-2">
                    <div class="card-wrapper swiper-wrapper py-4">
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/13.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      کیسه خواب
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/14.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      صاف کننده کمر و گردن
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/15.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      پالتو تمام چرم
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/16.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      مرطوب کننده هوا
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/17.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                     ساعت زنانه
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="{{ asset('assets/images/productSlider/18.jpg') }}" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
        ...
        <div class="bg-white rounded-2xl py-8 shadow-xl my-10">
            <div class="flex justify-between px-5 md:px-10 items-center">
                ...
                <a href="./blog.html"><div class="transition px-4 py-2 rounded-xl flex justify-center items-center text-red-500 hover:text-red-600">مطالب بیشتر<img class="w-4" src="{{ asset('assets/images/others/arrow-left.png') }}" alt=""></div></a>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-10 gap-5">
                <a href="./blog(single).html" class="shadow-lg rounded-3xl p-4 hover:text-red-600 transition">
                    <div>
                        <img class="rounded-xl hover:scale-105 transition" src="{{ asset('assets/images/blog/lavazem.jpg') }}" alt="">
                    </div>
                ...
                <a href="./blog(single).html" class="shadow-lg rounded-3xl p-4 hover:text-red-600 transition">
                    <div>
                        <img class="rounded-xl hover:scale-105 transition" src="{{ asset('assets/images/blog/bag.jpg') }}" alt="">
                    </div>
                    <div class="text-sm opacity-90 py-5">
                ...
                <a href="./blog(single).html" class="shadow-lg rounded-3xl p-4 hover:text-red-600 transition">
                    <div>
                        <img class="rounded-xl hover:scale-105 transition" src="{{ asset('assets/images/blog/car.jpg') }}" alt="">
                    </div>
                    <div class="text-sm opacity-90 py-5">
                ...
                <a href="./blog(single).html" class="shadow-lg rounded-3xl p-4 hover:text-red-600 transition">
                    <div>
                        <img class="rounded-xl hover:scale-105 transition" src="{{ asset('assets/images/blog/chador.jpg') }}" alt="">
                    </div>
                    <div class="text-sm opacity-90 py-5">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/sliderHero.js') }}"></script>
    <!-- PRODUCT SLIDER -->
    <script src="{{ asset('assets/js/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('assets/js/scriptSlider.style.js') }}"></script>
    <!-- BIG SLIDER -->
    <script src="{{ asset('assets/js/bigSlider.js') }}"></script>
    <!-- FOR TIMER OFF -->
