...
<div>
    ...
    <nav
        ...
        <a class="order-2" href="{{ route('home') }}">
            <img class="w-36" src="{{ asset('assets/images/logo/3.jpeg') }}" alt="" />
        </a>
            ...
            <div class="-mx-1">
                <ul class="flex w-full flex-wrap items-center h-10">
                    ...
                    @foreach($categories as $category)
                        <li class="block relative" x-data="{showChildren:false}">
                            <a
        ...
        <nav
            ...
            <div class="flex justify-center items-center mb-4">
                <a class="order-1" href="./index.html">
                    <img class="w-32" src="{{ asset('assets/images/logo/3.jpeg') }}" alt="" />
                </a>
            </div>
            <div>
                <ul class="space-y-3">
