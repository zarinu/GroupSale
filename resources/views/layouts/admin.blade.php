...
{{--    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">--}}
    <link rel="stylesheet" href="{{ asset('/assets/admin/downloaded/css.css') }}">
    <!-- bootstrap rtl -->
...
<div class="wrapper">
    ...
    @include('layouts.partials.admin_panel.navbar')

    @include('layouts.partials.admin_panel.sidebar')

    <div class="content-wrapper">
        @include('layouts.partials.admin_panel.messages')
